...
export default function Home() {
  ...
  // console.log(showButton,isDecript);

  return (
    <>
      <HomeAnnim isEnd={isEnd}/>
      <div className="w-full">
        {(isLoad||!showButton)&&<div role="status" className="mb-2 flex justify-center items-center">
        ...
        <>
          {(isDecript)?
          <ButtonNext text="Fais moi lire" root="slider"/>:
          <ButtonNext text="Fais moi lire" root="form"/>
          }
        </>
        }
      </div>
